...
namespace BCAddressGeocoder.Commands
{
    ...
    public class GetAddressesCommand : PSCmdlet
    {
        ...
        public string MatchPrecision { get; set; } = string.Empty;
        ...
        public string MatchPrecisionNot { get; set; } = string.Empty;
        ...
        public string UnitDesignator { get; set; } = string.Empty;
        ...
        public string UnitNumberSuffix { get; set; } = string.Empty;
        ...
        public string CivicNumberSuffix { get; set; } = string.Empty;
        ...
        public string StreetQualifier { get; set; } = string.Empty;
        ...
        public string NotLocalities { get; set; } = string.Empty;
        ...
        public string ParcelPoint { get; set; } = string.Empty;
